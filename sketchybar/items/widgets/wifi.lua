...
wifi:subscribe({ "wifi_change", "system_woke" }, function(env)
    sbar.exec(
    "for i in 1 2 3 4 5 6 7 8 9; do ipconfig getifaddr en$i 2>/dev/null && echo en$i && exit; done; ipconfig getifaddr en0 2>/dev/null && echo en0",
        function(result)
            ...
            active_interface .. " network_update 2.0")
...
"for i in 1 2 3 4 5 6 7 8 9; do ipconfig getifaddr en$i 2>/dev/null && echo en$i && exit; done; ipconfig getifaddr en0 2>/dev/null && echo en0",
    function(result)
        ...
        sbar.exec("killall network_load >/dev/null; $CONFIG_DIR/helpers/event_providers/network_load/bin/network_load " ..
        active_interface .. " network_update 2.0")
        -- Update icon
        local icon_set = (connection_type == "ethernet") and icons.ethernet or icons.wifi
        local connected = connection_type ~= "none"
